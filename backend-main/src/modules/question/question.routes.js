...
const { addQuestion, updateAnswerPic, updateQuestion, checkTheAnswer, getQuestionDetails, deleteQuestion, addGraphQuestion, updateAutoCorrect, getAllQuestions } = require('./controller/question.controller')
const upload = require('../../middleware/handleMulter')
const { wrapMulter } = require('../../middleware/handleMulter')
const { adminAuth } = require('../../middleware/auth')

questionRouter.post('/question/addQuestion', adminAuth, wrapMulter(upload.single("image")), addQuestion)
...
questionRouter.get('/question/getAllQuestions', getAllQuestions)
