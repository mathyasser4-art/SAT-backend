...
const { itAuth, teacherAuth, itOrTeacherAuth } = require('../../middleware/auth')
...
teacherRouter.put('/teacher/addTeacherToClass/:classID/:teacherID', itOrTeacherAuth, addTeacherToClass)
teacherRouter.get('/teacher/search/:searchKey', itOrTeacherAuth, search)
teacherRouter.get('/teacher/getTeacherToClass', itOrTeacherAuth, getTeacherToClass)
teacherRouter.put('/teacher/removeTeacherFromClass/:teacherID/:classID', itOrTeacherAuth, removeTeacherFromClass)
